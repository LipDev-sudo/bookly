      ...
      <header className="mb-8 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Consulte atendimentos passados e próximos horários.
          </p>
        </div>
        <Link
          ...
          <table className="w-full text-left text-sm">
            <thead className="border-b border-border bg-muted/50">
              <tr>
                ...
                <th className="sr-only px-4 py-3 font-medium">Ações</th>
              </tr>
            </thead>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1">
                        ...
                        <DeleteButton
                          ...
                          id={a.id}
                          label={`agendamento de ${start.toLocaleDateString("pt-BR", { month: "short", day: "numeric" })}`}
                        />
                      </div>
                    </td>
                  </tr>
  ...
  return (
    <div className="rounded-lg border border-dashed border-border bg-card p-12 text-center">
      ...
      <p className="mx-auto mt-2 max-w-sm text-sm text-muted-foreground">
        Adicione o primeiro horário para começar a organizar os atendimentos.
      </p>
      <Link
        href="/dashboard/appointments/new"
